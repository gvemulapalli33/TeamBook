const people = {
  developers: [
    {id: 1, name: 'Zikie', quote: 'You miss all the shots you don\'t take.', goals: 'Most Likely to Win the PGA', photo: './eric.jpg'},
    {id: 2, name: 'Yiang', quote: 'I believe in you, cuties!', goals: 'Most Likely to Be an Actual Superhero', photo: './amy.jpg'},
    {id: 3, name: 'Geetha', quote: 'Don\'t put the world on your shoulders.', goals: 'Most Likely to Save the Planet from Alien Invasion', photo: './khalid.png'},
    {id: 4, name: 'Aneesh', quote: 'You do you.', goals: 'Most Likely to Win a Grammy', photo: './travis.jpg'},
